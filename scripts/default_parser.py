...
def init_parser():
    ...
    parser.add_argument('--load-pose', action='store_true',
                        help='use pose to assist the learning process')
    parser.add_argument('--graph-matching', action='store_true',
                        help='use graph matching to train the network')
    ...
    parser.add_argument('--reg-matching-score-epoch', type=int, default=5,
                        help='number of epochs to start using matching regression loss')
    ...
    parser.add_argument('--use-att-loss', action='store_true',
                        help='use regularizer to separate att map')
    ...
    parser.add_argument('--part-score', action='store_true')
    parser.add_argument('--num-att', type=int, default=6)
    ...
    parser.add_argument('--ranks', type=int, default=[1, 3, 5, 10, 20], nargs='+',
                        help='cmc ranks')
...
def imagedata_kwargs(parsed_args):
    return {
        ...
        'load_pose':parsed_args.load_pose
    }
...
def engine_run_kwargs(parsed_args):
    return {
        ...
        'load_pose':parsed_args.load_pose,
        'part_score':parsed_args.part_score
    }
