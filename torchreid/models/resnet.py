...
from ..utils.vis_featmat_cluster import vis_featmat_DBSCAN, vis_featmat_Kmeans
...
class ResNet(nn.Module):
    ...
    def forward(self, x, eval_bn=False):
        ...
        if not self.training and not eval_bn:
            return v
...
# class resnet50_nonlocal(ResNet):
#     def __init__(self):
