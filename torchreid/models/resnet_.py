...
__all__ = ['resnet50_', 'resnet50_fc512_']
...
def resnet50_(num_classes, loss, pretrained='imagenet', **kwargs):
    model = ResNet(
...
def resnet50_fc512_(num_classes, loss, pretrained='imagenet', **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
